  ...
  return (
    <>
      <ListItemButton onClick={handleClick}>
       {typeof getButtonChildren === 'function' ? getButtonChildren(open) :
        (
            <>
                <ListItemIcon>
                {open ? startOpenIcon : startCloseIcon}
                </ListItemIcon>
                <ListItemText 
                    primary={typeof getPrimaryText === 'function'  ? getPrimaryText(open) : null}
                />
